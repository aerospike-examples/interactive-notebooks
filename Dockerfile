FROM arrowplum/java-notebook:latest
...
# Install Aerospike Server and Tool

RUN \
  apt-get update -y \
  && apt-get install -y --no-install-recommends build-essential wget lua5.2 gettext-base libldap-dev\
