...
ENV AEROSPIKE_SHA256 65804f3ec5f3dfe64a1287dd3aecab72b3d494ac91d8698de462e375b9824d38
...
RUN mkdir /opt/spark-nb; cd /opt/spark-nb\
  ...
  && wget "https://aerospike.com/artifacts/aerospike-spark/3.2.1/aerospike-spark-assembly-3.2.1.jar"
